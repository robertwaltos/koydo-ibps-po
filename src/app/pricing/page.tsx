...
export const metadata: Metadata = {
  title: "Pricing — Ibps Po Premium",
  description: "Unlock unlimited Ibps Po practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=ibps-po&cadence=annual`;
